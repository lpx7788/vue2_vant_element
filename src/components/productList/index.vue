            ...
            <div class=" bg-purple">
              <el-row :gutter="30" style="margin-top:0;" class="listRightTit">
                    ...
                    <el-breadcrumb separator-class="el-icon-arrow-right">
                      ...
                      <el-breadcrumb-item>Product Display</el-breadcrumb-item>
                    </el-breadcrumb>
                    </el-col>
                </el-row>
                ...
                <el-row :gutter="30" v-for="item in listNavrightContent.right_list"  :key="item.id" v-show="imgDetailShow==false" >
                  <el-col :span="8" class="right_list_item"  v-for="i in item" :key="i.id" >
                    ...
                    <div class="grid-content partnerItem bg-purple textC"  @click="toDetailPage(i.id)"  v-else >
    ...
    return {
      ...
      listNavrightContent: {
        ...
        right_list: [
          {
            id: "55",
            img:  'http://adop.lcjzm.com/assets/goods2.png',
      ...
      menuList: [
        {
          ...
          title: "PRODUCTS", //菜单项名称
          children: [
            {
              id: "11",
              path: "/func311",
              title: " 3D Tempered Glass",
              children: []
            },
            {
              id: "12",
              path: "/func312",
              title: "3D Curved Glass",
              children: []
            },
            {
              id: "13",
            ...
            },
            {
              id: "16",
              path: "/func313",
              title: "2.5D Full Cover Tempered",
              children: []
            },
            {
              id: "17",
              path: "/func313",
              title: "Aluminum Alloy Glass",
              children: []
            },
            {
              id: "18",
              path: "/func313",
              title: "Silicone Glass",
              children: []
            },
            {
              id: "19",
              path: "/func313",
              title: "2.5D Full Cover Tempered Glass",
              children: []
            },
            {
              id: "20",
